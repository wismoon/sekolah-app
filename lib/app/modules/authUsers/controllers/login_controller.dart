...
class LoginController extends GetxController {
    ...
    if (email.isNotEmpty && password.isNotEmpty) {
      ...
      try {
        ...
        if (docUser.exists) {
          ...
          DocumentSnapshot<Map<String, dynamic>> docSiswa = await firestore
              .collection("siswa")
  ...
  void handleUserLogin(String role, String email, String password,
    ...
    if (credential.user!.emailVerified == true) {
      ...
      if (role == "student") {
        ...
        String nim = docSiswa["nim"];
        await box.write("nim", nim);

        Get.offAllNamed(Routes.STUDENT_HOME, parameters: {'nim': nim});
      } else if (role == "admin") {
